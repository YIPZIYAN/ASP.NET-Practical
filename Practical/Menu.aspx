<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Practical.Menu" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            (All users including anonymouns users)<br />
            <br />
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/MyAccount/MyAccount.aspx">Edit My Account</asp:HyperLink>
            <br />
            (All autheticated users)<br />
            <br />
            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/Maintenance/Maintenance.aspx">Maintain Data Table</asp:HyperLink>
            <br />
